  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-background p-4">
      ...
      <div className="absolute inset-0 z-0">
         <div className="absolute -top-[20%] -left-[10%] h-[70vh] w-[70vh] rounded-full bg-primary/20 blur-[120px]" />
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <Input
                  ...
                  required
                  className="pl-12 h-11 bg-background/50 border-input/50 focus:bg-background transition-all duration-300"
                />
              </div>
            </div>
